            ...
            <html xmlns="http://www.w3.org/1999/xhtml">
                <xsl:element name="head">
                    ...
                    font-size: 1.05em; 
                            ...
                            td.darkBlue { background-color: #0C2577 ; } 
                            hr { color: #C0C0C0 ;
                            border-style: dotted ; } 
                            a:link { color: #0c2577; TEXT-DECORATION: NONE;
                            HEIGHT: 18PX; } 
                            a:hover { color: black; TEXT-DECORATION: underline; HEIGHT:
                            18PX; } 
                            a:visited { color: #660000; TEXT-DECORATION: none; HEIGHT: 18PX; }
                            h4 { margin:0; text-decoration: none; } 
                            h3 { margin:0; text-decoration:
                            none; } 
                            a.footnote { font-size: 8pt; } 
                            p.resp { margin:0; font-style:
                            italic; font-size: 9pt; } 
            
                            .box{font-family:Arial,sans-serif;Georgia; 
                            font-size:smaller;}
...
a.popup:hover span{
	...
	text-align:center; */
                ...
                <body>
                    ...
                    <script type="text/javascript" src="https://disc.leidenuniv.nl/exlibris/dtl/u3_1/dtle/www_r_eng/js/teiChoice.js">
                    ...
                    <p align="center">
                        ...
                        <table width="75%" border="0" cellpadding="20"
                            style="background-color:#F7F7ED; ">
                            <tr>
                                <td style="background-color: #0C2577 ;">
                                    <xsl:element name="img">
                                        <xsl:attribute name="src">
                                            <xsl:text>https://bookandbyte.universiteitleiden.nl/DMT/XSLT/UL_logo.png</xsl:text>
                                        </xsl:attribute>
                                   ...
                                   <!-- 
                                                    <xsl:element name="a">
                                                        <xsl:attribute name="href">
                                                            <xsl:text>https://disc.leidenuniv.nl:443/webclient/DeliveryManager?custom_att_2=simple_viewer&amp;pid=</xsl:text>
                                                            <xsl:value-of select="tei:teiHeader/tei:fileDesc/tei:sourceDesc/tei:biblFull/tei:publicationStmt/tei:idno[ @type = 'digitoolPid'  ]"/>
                                                        </xsl:attribute>
                                                        -->
